namespace BolCom\RetailerApi\Model\EntityLink {
    data Type = CART | ORDER | ORDER_ITEM | SHIPMENT | RETURN_ITEM | OFFER | PROCESS_STATUS_CONFIRM_SHIPMENT | PROCESS_STATUS_OFFER | PROCESS_STATUS_DELETE_OFFER deriving(Enum(useValue)) with (
            CART: 'cart',
            ORDER: 'order',

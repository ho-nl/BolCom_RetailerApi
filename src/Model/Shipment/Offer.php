...
final class Offer
{
    ...
    public function withOfferId(\BolCom\RetailerApi\Model\Offer\OfferId $offerId): Offer
    {
        return new self($offerId, $this->reference);
    }

    public function withReference(\BolCom\RetailerApi\Model\Offer\Reference $reference): Offer
    {

...
final class GetFbbShippingLabel extends \Prooph\Common\Messaging\Query
{
    use \Prooph\Common\Messaging\PayloadTrait;

    public const MESSAGE_NAME = 'BolCom\RetailerApi\Model\Inbound\Query\GetFbbShippingLabel';
    ...
    public static function with(\BolCom\RetailerApi\Model\Inbound\InboundId $inboundId): GetFbbShippingLabel
    {
        return new self([

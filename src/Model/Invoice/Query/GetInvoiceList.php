...
final class GetInvoiceList extends \Prooph\Common\Messaging\Query
{
    ...
    const MESSAGE_NAME = 'BolCom\RetailerApi\Model\Invoice\Query\GetInvoiceList';
    ...
    public static function with(\BolCom\RetailerApi\Model\Invoice\Period $period = null): GetInvoiceList
    {
        return new self([
